...
if devrambo:get(DEVRMBO.."skrafa:name" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then   
if text and text:match("^الغاء$") then 
rambo_sendMsg(msg.chat_id_, msg.id_, 1, "*💥¦* تم الغاء امر الزخرفه ✔", 1, "md")
devrambo:del(DEVRMBO.."skrafa:name" .. msg.chat_id_ .. "" .. msg.sender_user_id_)     
return false
end
if text then
...
if devrambo:get(DEVRMBO..'lock:skrfa'..msg.chat_id_)  then
taha = '*📮¦ تم تفعيل الزخرفه *\n✓' 
rambo_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
devrambo:del(DEVRMBO..'lock:skrfa'..msg.chat_id_) 
else
...
if not devrambo:get(DEVRMBO..'lock:skrfa'..msg.chat_id_)  then
taha = '*📮¦ تم تعطيل الزخرفه *\n✓' 
rambo_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
devrambo:set(DEVRMBO..'lock:skrfa'..msg.chat_id_,true) 
else
...
if not devrambo:get(DEVRMBO.."lock:skrfa"..msg.chat_id_) then   
devrambo:setex(DEVRMBO.."skrafa:name" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 10000, true)   
